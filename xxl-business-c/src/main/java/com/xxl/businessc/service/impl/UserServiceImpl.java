package com.xxl.businessc.service.impl;

import com.xxl.businessc.domain.User;
import com.xxl.businessc.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public void initData() {
        ...
        userList.add(new User(1L, "xxl1", "123456"));
        userList.add(new User(2L, "xxl2", "123456"));
        userList.add(new User(3L, "xxl3", "123456"));
    }
}
